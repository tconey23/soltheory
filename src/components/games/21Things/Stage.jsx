...
const Stage = ({ 
  ...
  return (
    <Stack height="100%" width="95%" alignItems="center" sx={{ scale: isMobile ? 0.95 : 1 }}>
      ...
      <ImageList sx={{ width: '100%', height: stageNum > 1 ? '25%' : '80%' }} cols={3} rowHeight={100} gap={0}>
        {displayPrompts.map((p, i) => (
          <Stack height={'fit-content'} justifyContent="center" key={i} onClick={() => handleSelect(p, i)}>
