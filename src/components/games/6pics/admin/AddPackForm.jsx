...
import { Button, Checkbox, CircularProgress, FormLabel, List, ListItem, Stack, Typography } from '@mui/material';
import {FormControl, InputLabel, Input, FormHelperText} from '@mui/material';
import VideoObject from './VideoObject';
import { supabase } from '../../../../business/supabaseClient';
import { display, height } from '@mui/system';

const AddPackForm = ({setExpandAddNewPack, resetData, setPacks}) => {
  ...
  return (
    <Stack title='add_pack_form' key={resetData} direction={'column'} sx={{width: '100%', overflowY: 'auto', height: '275px'}}>
